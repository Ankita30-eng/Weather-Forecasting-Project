...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=6830ce72d3a7aa4d1d5c5683d17ac383'
    
    # Parameters to request temperature in metric units (Celsius)
    PARAMS = {'units': 'metric'}

    # Your Google Custom Search API Key (keep it secret)
    API_KEY = 'AIzaSyASJPeRh-LonyI3oqn5FxtS9WM5ejqLbHs'

    # Your Google Custom Search Engine ID
    SEARCH_ENGINE_ID = '175c1d8fc74b7478e'
